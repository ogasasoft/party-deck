...
- 日本マップ当ては本番のゲーム登録、画面遷移、配信データから外す。復活用資産と手順は `archive/geo/README.md` に保管する。
...
- ルーレット、コイン、サイコロはゲーム登録へ混ぜず、暗号学的乱数を優先する独立した便利ツールとして扱う。詳細は `docs/random-tools-spec.md` を参照する。
